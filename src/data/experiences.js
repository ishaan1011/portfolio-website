import centralize from "../assets/images/centralize.png";
...
export const experiences = [
  {
    ...
    bio: "6th engineer at Centralize | Helping revenue teams operationalize multithreading with AI.",
    color: emerald,
  },
  {
    logo: comm360,
  ...
  },
  {
    ...
    title: "Software Engineer",
    bio: "As founder and lead engineer of Comm360, incubated at TipTop Technologies, I built an AI-powered communication platform that enables real-time, multilingual, and autonomous meeting participation. I designed and deployed a retrieval-augmented generation (RAG) engine that indexes company conversations, transcripts, and chat logs to deliver contextual insights, summaries, and action items across teams.",
    color: vanilla,
  },
  {
    logo: neuroml,
